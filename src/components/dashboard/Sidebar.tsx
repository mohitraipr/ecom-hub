      ...
      <div className="p-4 border-t border-ink-800">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-ink-400 truncate">{tenant?.name}</p>
          </div>
        </div>
        <button
          onClick={() => logout()}
          className="w-full flex items-center gap-2 px-3 py-2 text-sm text-ink-400 hover:text-white hover:bg-ink-800 rounded-lg transition-colors"
        >
